/**
 * DESHAL ERP — Barcode (Code-128B) Domain Engine
 * Domain Layer: Code-128 Subset B binary encoding, modulo 103 checksum calculation,
 * quiet zone module math, and SVG vector coordinate generation.
 */
...
export const START_CODE_B = 104; // Index 104 in standard table for START B
