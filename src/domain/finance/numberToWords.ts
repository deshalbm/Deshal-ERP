/**
 * DESHAL ERP — Financial Number-To-Words Domain Engine (Tafqeet)
 * Domain Layer: Pure financial monetary text formatting in Arabic & English with GCC subunit support.
 */
