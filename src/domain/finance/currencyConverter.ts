/**
 * DESHAL ERP — CURRENCY CONVERTER & EXCHANGE RATES DOMAIN MODULE
 * 
 * Pure domain rules for currency metadata lookup, central exchange rate calculations,
 * multi-currency amount conversion, currency formatting, and live rate fallback.
 */
...
/**
 * Get active rates (from custom rates or default)
 */
