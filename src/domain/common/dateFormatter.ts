/**
 * DESHAL ERP — Date Formatter Domain Engine
 * Domain Layer: Gregorian date formatting to DD/MonthName/YYYY for official document vouchers and contract headers.
 */
