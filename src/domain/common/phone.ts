/**
 * DESHAL ERP — Phone Normalization & Display Domain Engine
 * Domain Layer: Canonical Omani (+968) and international phone number normalization and display formatting.
 */
