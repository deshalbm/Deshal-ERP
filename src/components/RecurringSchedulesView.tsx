...
export function RecurringSchedulesView({
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-16">
      ...
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-indigo-50/80 via-slate-50 to-purple-50/80 rounded-3xl p-6 sm:p-8 text-slate-900 border border-slate-200 shadow-xs relative overflow-hidden">
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-black uppercase tracking-wider bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full border border-indigo-200">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              ...
              className="px-5 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl text-sm shadow-xs transition-all flex items-center gap-2 cursor-pointer active:scale-95"
            >
        ...
        <div className="mt-6 pt-5 border-t border-slate-200 flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-white hover:bg-slate-100 text-slate-700 rounded-xl text-xs font-semibold border border-slate-200 shadow-2xs transition-colors flex items-center gap-1.5 cursor-pointer"
          >
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className={`px-2.5 py-1 rounded-md text-[11px] font-bold cursor-pointer ${
                dueFilter === "ALL" ? "bg-indigo-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
              }`}
            >
              {isRtl ? "الكل" : "All"}
            </button>
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col border border-slate-200 animate-scaleUp overflow-hidden">
            <div className="px-6 py-4 bg-white text-slate-900 border-b border-slate-200 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-black text-slate-900">{t("scheduleHistory")}</h3>
                  <p className="text-xs text-slate-500">{historySchedule.title}</p>
                </div>
              </div>
              <button
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-[11px] text-slate-500">
                            {exec.executedAt} ({exec.triggeredBy})
                          </span>
                        </div>
                      </div>
            ...
            <div className="p-4 border-t border-slate-200 bg-slate-50 flex justify-end shrink-0">
              <button
                onClick={() => setHistorySchedule(null)}
                className="px-5 py-2 bg-slate-100 border border-slate-200 text-slate-700 rounded-xl text-xs font-bold hover:bg-slate-200 transition-colors cursor-pointer"
              >
                {t("close")}
              </button>
            </div>
