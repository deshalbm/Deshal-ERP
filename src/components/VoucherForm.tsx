...
export const VoucherForm: React.FC<VoucherFormProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12 font-sans" dir={dir}>
      ...
      <div className="bg-slate-100 text-slate-900 p-5 rounded-3xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-1 text-xs font-black rounded-lg bg-indigo-600 text-white uppercase tracking-wider">
              {isRTL ? "محرر القوالب التفاعلي Live Document Canvas" : "Live Document Canvas"}
            </span>
          </div>
          <h1 className="text-lg sm:text-xl font-black mt-1 text-slate-900">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            onClick={onPreview}
            type="button"
            className="flex items-center gap-1.5 px-4 py-2 text-xs font-semibold rounded-xl bg-white text-slate-700 hover:bg-slate-50 border border-slate-200 transition-all cursor-pointer"
          >
          ...
          <button
            onClick={onSave}
            type="button"
            className="flex items-center gap-1.5 px-5 py-2 text-xs font-black rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white shadow-md transition-all cursor-pointer"
          >
