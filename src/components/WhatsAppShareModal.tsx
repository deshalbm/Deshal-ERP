...
✅ هذه الفاتورة صادرة إلكترونياً ومعتمدة ضريبياً.`;
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 rounded-3xl max-w-xl w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95 max-h-[94vh] flex flex-col" dir={dir}>
        
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-200 pb-3 shrink-0">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-emerald-50 text-emerald-600 rounded-2xl border border-emerald-200 shadow-xs">
            ...
            <div className="text-start">
              <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                ...
                {isBaileysConfigured ? (
                  <span className="px-2 py-0.5 rounded-full text-[10px] bg-emerald-50 text-emerald-700 font-mono flex items-center gap-1 border border-emerald-200">
                    <Radio className="w-2.5 h-2.5 text-emerald-600 animate-pulse" />
                    <span>Baileys Server API</span>
                  </span>
                ) : (
                  <span className="px-2 py-0.5 rounded-full text-[10px] bg-indigo-50 text-indigo-700 font-mono border border-indigo-200">
                    WhatsApp Web
                  </span>
                )}
              </h3>
          ...
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-2.5">
            ...
            <div className="flex gap-2">
              <select
                ...
                className="bg-white border border-slate-200 text-slate-900 rounded-xl px-3 py-2.5 text-xs font-mono outline-none focus:border-emerald-500 shrink-0 cursor-pointer"
              >
              ...
              <input
                ...
                className="flex-1 bg-white border border-slate-200 text-slate-900 rounded-xl px-3.5 py-2.5 text-xs font-mono font-bold outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
              />
            </div>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[11px] font-bold text-slate-500 hover:text-emerald-600 flex items-center gap-1 transition-colors cursor-pointer"
              >
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-3.5 text-slate-800 font-sans text-xs leading-relaxed outline-none focus:border-emerald-500 focus:bg-white"
        ...
        <div className="pt-3 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-2.5 shrink-0">
          ...
          <button
            type="button"
            onClick={handleCopyMessage}
            className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
          >
            ...
            {isBaileysConfigured ? (
              <>
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 disabled:bg-slate-200 disabled:text-slate-400 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-xs transition-all cursor-pointer"
                >
                  {isSendingViaBaileys ? (
                    <>
              ...
              <button
                type="button"
                onClick={handleLaunchWhatsAppWeb}
                className="flex-1 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-xs transition-all cursor-pointer"
              >
