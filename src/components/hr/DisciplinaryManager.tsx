...
export const DisciplinaryManager: React.FC<DisciplinaryManagerProps> = ({
  ...
  const handleOpenNew = () => {
    ...
    setFormData({
      ...
      issueDate: new Date().toISOString().substring(0, 10),
      issuedBy: 'emp-1',
      issuedByName: 'إدارة الموارد البشرية',
      issuedByRole: 'المدير الإداري',
      reason: '',
      details: '',
      penaltyDetails: '',
      employeeExplanation: '',
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    const actionToSave: DisciplinaryAction = {
      ...
      issuedByName: formData.issuedByName || 'إدارة الموارد البشرية',
      issuedByRole: formData.issuedByRole || 'المدير الإداري',
