...
export const DEFAULT_INITIAL_JOURNAL_ENTRIES: JournalEntry[] = [
  {
    ...
    referenceNumber: 'OPENING-2026',
    descriptionAr: 'قيد افتتاح السنة المالية 2026 والأرصدة المدورة',
    descriptionEn: 'Opening entry for FY 2026 balances',
    totalDebit: 66720,
    totalCredit: 66720,
    isBalanced: true,
    createdBy: 'سعيد الشحي (المدير المالي)',
    postedBy: 'سعيد الشحي (المدير المالي)',
    ...
    lines: [
      {
        ...
        debit: 4500,
        credit: 0,
        descriptionAr: 'رصيد نقدية الخزينة الافتتاحي'
      },
      {
        id: 'jel-2',
        accountId: 'acc-1130',
        accountCode: '1130',
        accountNameAr: 'بنك مسقط - الحساب الجاري',
        debit: 18500,
        credit: 0,
        descriptionAr: 'رصيد حساب بنك مسقط الجاري'
      },
      {
        id: 'jel-3',
        accountId: 'acc-1140',
        accountCode: '1140',
        accountNameAr: 'بنك ظفار - حساب المدفوعات',
        debit: 7200,
        credit: 0,
        descriptionAr: 'رصيد حساب بنك ظفار'
      },
      {
        id: 'jel-4',
        accountId: 'acc-1200',
        accountCode: '1200',
        accountNameAr: 'الذمم المدينة وحسابات العملاء (AR)',
        debit: 3200,
        credit: 0,
        descriptionAr: 'أرصدة العملاء الافتتاحية'
      },
      {
        id: 'jel-4_5',
        accountId: 'acc-1230',
        accountCode: '1230',
        accountNameAr: 'ضريبة القيمة المضافة المستردة - المدخلات',
        debit: 420,
        credit: 0,
        descriptionAr: 'رصيد ضريبة مدخلات مستردة'
      },
      {
        id: 'jel-5',
        accountId: 'acc-1300',
        ...
        debit: 8600,
        credit: 0,
        descriptionAr: 'قيمة بضاعة أول المدة'
      },
      {
        id: 'jel-6',
        accountId: 'acc-1510',
        accountCode: '1510',
        accountNameAr: 'الأثاث والتجهيزات المكتبية والقاعات',
        debit: 14500,
        credit: 0,
        descriptionAr: 'تكلفة الأثاث والتجهيزات'
      },
      {
        id: 'jel-7',
        accountId: 'acc-1520',
        accountCode: '1520',
        accountNameAr: 'أجهزة الحاسوب وتقنية المعلومات',
        debit: 9800,
        credit: 0,
        descriptionAr: 'تكلفة أجهزة الحاسوب والتقنية'
      },
      {
        id: 'jel-8',
        accountId: 'acc-1590',
        ...
        debit: 0,
        credit: 3200,
        descriptionAr: 'مجمع إهلاك الأصول المتراكم'
      },
      {
        id: 'jel-9',
        accountId: 'acc-2110',
        accountCode: '2110',
        accountNameAr: 'الذمم الدائنة والموردين (AP)',
        debit: 0,
        credit: 2450,
        descriptionAr: 'أرصدة الموردين الافتتاحية'
      },
      {
        id: 'jel-10',
        accountId: 'acc-2120',
        accountCode: '2120',
        accountNameAr: 'أمانات وتأمينات المستأجرين المستردة',
        debit: 0,
        credit: 1200,
        descriptionAr: 'ودائع الضمان المحصلة'
      },
      {
        id: 'jel-11',
        accountId: 'acc-2130',
        accountCode: '2130',
        accountNameAr: 'ضريبة القيمة المضافة المحصلة - المخرجات',
        debit: 0,
        credit: 980,
        descriptionAr: 'رصيد ضريبة مخرجات مستحق'
      },
      {
        id: 'jel-12',
        accountId: 'acc-2150',
        accountCode: '2150',
        accountNameAr: 'التأمينات الاجتماعية المستحقة (PASI)',
        debit: 0,
        credit: 320,
        descriptionAr: 'مستحقات التأمينات الشهرية'
      },
      {
        id: 'jel-13',
        accountId: 'acc-2160',
        accountCode: '2160',
        accountNameAr: 'إيرادات عقود واشتراكات مؤجلة',
        debit: 0,
        credit: 1500,
        descriptionAr: 'إيرادات مقدمة'
      },
      {
        id: 'jel-14',
        accountId: 'acc-3100',
        ...
        debit: 0,
        credit: 40000,
        descriptionAr: 'رأس المال المؤسس'
      },
      {
        id: 'jel-15',
        accountId: 'acc-3200',
        ...
        debit: 0,
        credit: 17070,
        descriptionAr: 'الأرباح المدورة السابقة'
      }
    ],
  ...
  {
    id: 'je-adj-001',
    entryNumber: 'ADJ-2026-0001',
    date: '2026-02-28',
    type: 'ADJUSTING',
    status: 'POSTED',
    referenceType: 'MANUAL',
    referenceNumber: 'ADJ-DEPR-FEB',
    descriptionAr: 'قيد تسوية إهلاك الأصول الثابتة لشهر فبراير 2026',
    descriptionEn: 'Monthly depreciation adjustment for Feb 2026',
    totalDebit: 350,
    totalCredit: 350,
    isBalanced: true,
    createdBy: 'سعيد الشحي (المدير المالي)',
    approvedBy: 'سعيد الشحي (المدير المالي)',
    postedBy: 'سعيد الشحي (المدير المالي)',
    ...
    lines: [
      {
        ...
        debit: 350,
        credit: 0,
        descriptionAr: 'إهلاك الأثاث وأجهزة الحاسوب لشهر فبراير'
      },
      {
        id: 'adj-line-2',
        accountId: 'acc-1590',
        ...
        debit: 0,
        credit: 350,
        descriptionAr: 'إضافة لمجمع الإهلاك المتراكم'
      }
    ],
...
export const DEFAULT_BANK_STATEMENT_TRANSACTIONS: BankStatementTransaction[] = [
  {
    id: 'stmt-tx-1',
    bankAccountId: 'bank-muscat-01',
    statementId: 'stmt-2026-02',
    transactionDate: '2026-02-05',
    valueDate: '2026-02-05',
    description: 'TRF FROM CLIENT OMRAN GROUP - INVOICE 2026-014',
    reference: 'FT2603681921',
    debit: 0,
    credit: 1250.000,
    balance: 19750.000,
    matchStatus: 'MATCHED',
    matchedJournalEntryId: 'je-auto-vouch-v-001',
    matchedAt: '2026-02-28T10:00:00Z',
    matchedBy: 'سعيد الشحي (المدير المالي)'
  },
  {
    id: 'stmt-tx-2',
    bankAccountId: 'bank-muscat-01',
    ...
    description: 'POS SETTLEMENT DESHAL CAFE - BANK MUSCAT POS',
    reference: 'POS-SETTLE-8812',
    debit: 0,
    credit: 420.500,
    balance: 20170.500,
    matchStatus: 'MATCHED',
    matchedJournalEntryId: 'je-auto-vouch-v-002',
    matchedAt: '2026-02-28T10:00:00Z',
    matchedBy: 'سعيد الشحي (المدير المالي)'
  },
  {
    ...
    description: 'MONTHLY ACCOUNT MAINTENANCE FEE & SMS ALERT',
    reference: 'CHG-BM-FEB26',
    debit: 50.000,
    credit: 0,
    balance: 20120.500,
    matchStatus: 'UNMATCHED',
    notes: 'رسوم بنكية شهرية تحتاج لتوليد قيد مصروف بنكي'
  },
  {
    id: 'stmt-tx-4',
    bankAccountId: 'bank-muscat-01',
    ...
    description: 'DIRECT DEBIT UTILITIES NAMA WATER & POWER',
    reference: 'DD-NAMA-202602',
    debit: 210.000,
    credit: 0,
    balance: 19910.500,
    matchStatus: 'POSSIBLE_MATCH',
    notes: 'سداد فواتير الكهرباء والمياه المباشر'
  }
];

export const DEFAULT_BANK_RECON_SESSIONS: BankReconciliationSession[] = [
  {
    id: 'recon-sess-2026-02',
    sessionNumber: 'RECON-2026-001',
    bankAccountId: 'bank-muscat-01',
    statementStartDate: '2026-02-01',
    statementEndDate: '2026-02-28',
    statementStartingBalance: 18500,
    statementEndingBalance: 19910.5,
    bookBalance: 18500,
    outstandingDepositsTotal: 1670.5,
    outstandingPaymentsTotal: 210,
    bankChargesTotal: 50,
    adjustmentsTotal: 0,
    reconciledBalance: 19910.5,
    difference: 0,
    status: 'DRAFT',
    reconciledBy: 'سعيد الشحي (المدير المالي)',
    importedFileName: 'Bank_Muscat_Statement_Feb_2026.xlsx',
    importedTransactionsCount: 4,
    matchedCount: 2,
